...
public class JDBCAdapter {
    ...
    static void testit2(String server, String driver, String user, String pass) {
        ...
        String sql0 = "CREATE TABLE ImageComp(ImagePath VARCHAR(50), ImageName VARCHAR(30), ImageSize VARCHAR(30), percentRed VARCHAR(10), percentGreen VARCHAR(10), percentBlue VARCHAR(10), Colorfulness  VARCHAR(30))";
