...
public class JDBCAdapter {
    ...
    public static void main1(String[] args) 
    {
       ...
       //server = "jdbc:mysql://localhost:3306/test"; 
       String  user = "sa";
       String  pass  = "";
    ...
    static void testit2(String server, String driver, String user, String pass) {
        ...
        String sql0 = "CREATE TABLE ImageComp(ImagePath VARCHAR(60), ImageName VARCHAR(60), ImageDate VARCHAR(30), percentRed VARCHAR(10), percentGreen VARCHAR(10), percentBlue VARCHAR(10), Colorfulness  VARCHAR(30))";
        String sql1 = "INSERT INTO ImageComp(ImageName) VALUES('D10012345');";
      ...
      //  adapter.executeUpdate(sql0);
        ...
        //System.out.println("number of records of affected = " + x);
         int x = adapter.executeUpdate(sql);
